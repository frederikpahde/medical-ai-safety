...
config_dir = "config_files/bias_mitigation_controlled/hyper_kvasir_attacked"
...
base_config = {
    ...
    'img_size': 224,
    'wandb_project_name': 'r2r-hyper-kvasir-attacked-mitigation',
...
for model_name, layer_names in [
    ...
    optim_name, lr, p_artifact = chosen_model_params[model_name]
