...
config_dir = "config_files/revealing/hyper_kvasir"

if os.path.isdir(config_dir):
    shutil.rmtree(config_dir)

with open("config_files/chosen_model_params.json", "r") as stream:
    chosen_model_params = json.load(stream)["hyper_kvasir"]
...
base_config = {
    ...
    'method': 'AClarc',
    'img_size': 224,
    'artifacts_file': 'data/artifacts_hyperkvasir.json',
    'wandb_api_key': 'YOUR_WANDB_KEY',
    'wandb_project_name': 'kvasir-data-annotation',
}
